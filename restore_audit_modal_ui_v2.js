...
// 1. Defining the Modal JSX (with correct escaping)
const modal = \`        {/* Audit Adjustment Modal (RESTORED) */}
        {isAdjModalOpen && (
...
// 2. Inject it before the specific section to be safe
content = content.replace('{currentView === \\'inventory-recipes\\' && (', modal + '\\n\\n        {currentView === \\'inventory-recipes\\' && (');

fs.writeFileSync('src/App.jsx', content);
console.log('Audit Modal UI fully restored into the React render tree!');
