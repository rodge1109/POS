...
CREATE TABLE IF NOT EXISTS public.customers (id SERIAL PRIMARY KEY, name VARCHAR(255) NOT NULL, email VARCHAR(255), phone VARCHAR(50), address TEXT, city VARCHAR(100), barangay VARCHAR(100), player_id VARCHAR(255), created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP, pin VARCHAR(6), credit_balance DECIMAL(10,2) DEFAULT 0, credit_limit DECIMAL(10,2) DEFAULT 1000, updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP);
CREATE TABLE IF NOT EXISTS public.customer_ledger (id SERIAL PRIMARY KEY, customer_id INTEGER, order_id INTEGER, transaction_type VARCHAR(50) NOT NULL, amount DECIMAL(10,2) NOT NULL, balance_after DECIMAL(10,2) NOT NULL, notes TEXT, created_by VARCHAR(100), created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP);
